var app = (function() {
    ...
    function Nt(t) {
      ...
      return {
        c() {
          (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> but for MF DOOM songs. Each song is randomly chosen from his discography, including features.</p> \n\n<p class="mb-3">Made by <a href="https://twitter.com/archer_uwu">Archer</a>. All copyright goes to MF DOOM, RCA Records, and other relevant parties.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>. See the source code <a href="https://glitch.com/edit/#!/zayn-heardle">here</a>.'),
          M(n, "class", "text");
        },
        m(e, t) {
          g(e, n, t);
        ...
        (O = new Rt({})), {
          c() {
            ...
            W.c(),
              ...
              (m = w("div")),
              (k = w("div")),
              (k.textContent = "Next MF DOOM song in:"),
              (b = x()),
              Q(S.$$.fragment),
              (D = x()),
              (T = w("div")),
    ...
    function an(e) {
      ...
      return {
        c() {
          (t = _("You got today's MF DOOM Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
        },
        m(e, s) {
    ...
    function ln(e) {
      ...
      return {
        c() {
          (t = _("You got today's MF DOOM Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
    ...
    function un(t) {
      ...
      return {
        c() {
          n = _("You didn't get today's MF DOOM Heardle. Better luck tomorrow!");
        },
        m(e, t) {
          g(e, n, t);
        },
    ...
    const Cn = ue([
      "MF DOOM - Operation: Greenbacks (feat. Megalon)",
      "King Geedorah - Krazy World",
      "MF DOOM - The Time We Faced Doom (Skit)",
      "MF DOOM - ? (feat. Kurious)",
      "MF DOOM - The Mic (feat. Pebbles The Invisible Girl)",
      "MF DOOM - ABSOLUTELY (feat. Madlib)",
      "MF DOOM - Beef Rap",
      "MF DOOM - Kon Queso",
      "MF DOOM - Rhymes Like Dimes (feat. DJ Cucumber Slice)",
      "MF DOOM - BUMPY'S MESSAGE (feat. Freddie Foxxx)",
      ...
      "MF DOOM - LIGHTWORKS (feat. J Dilla)",
      "MF DOOM - Gas Drawls",
      "Danger Doom - Old School Rules (feat. Talib Kweli)",
      ...
      "MF DOOM - One Beer",
      "MF DOOM - YESSIR! (feat. Raekwon)",
      "MF DOOM - CELLZ, Pt. 1 (feat. Charles Bukowiski)",
      "MF DOOM - CELLZ, Pt. 2",
      ...
      "MF DOOM - GAZZILLION EAR (feat. J Dilla)",
      "MF DOOM - MICROWAEVE MAYO",
      "Danger Doom - El CHupa Nibre",
      "King Geedorah - Take Me To Your Leader",
      "MF DOOM - Go with the FLow",
      "King Geedorah - The Final Hour",
      "Danger Doom - Sofa King",
      "MF DOOM - Guinnessess feat. Angelika & 4ize",
      "MF DOOM - Kookies",
      "MF DOOM - Who You Think I Am? (feat. K.D, King Ghidra, King, Megalon, Ro-Dan & X-Ray)",
      "MF DOOM - Hoe Cakes",
      "MF DOOM - The Hands of Doom (Skit)",
      "MF DOOM - The Mystery of Doom (Skit)",
      "MF DOOM - ANGELZ (feat. Ghostface Killah)",
      "MF DOOM - THAT'S THAT",
      "Danger Doom - Benzi Box (feat. CeeLo Green)",
      "MF DOOM - Back in the Days (Skit)",
      "MF DOOM - Rapp Snitch Knishes feat. Mr. Fantastik",
      "MF DOOM - Kon Karne",
      "MF DOOM - BALLSKIN",
      "MF DOOM - Potholderz feat. Count Bass D",
      "MF DOOM - SUPERVILLAINZ (feat. Kurious, Mobonix, Posdnous, Prince Paul & Slug)",
      "MF DOOM - Go with the Flow",
      ...
      "MF DOOM - Dead Bent",
      "MF DOOM - STILL DOPE (feat. Empress Starhh)",
      "King Geedorah - Next Levels",
      "MF DOOM - THANK YA",
      "MF DOOM - Doom, Are You Awake? (Skit)",
      "Danger Doom - No Names (feat. Money Mark)",
      ...
      On = {
        subscribe: ue(
          [{
              url: "https://soundcloud.com/mf-doom-official/operation-greenbacks-feat",
              answer: "MF DOOM - Operation: Greenbacks (feat. Megalon)",
            },
            {
              url: "https://soundcloud.com/king_geedorah/krazy-world?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Krazy World",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/the-time-we-faced-doom-skit?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - The Time We Faced Doom (Skit)",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/feat-kurious?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - ? (feat. Kurious)",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/the-mic-feat-pebbles-the?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - The Mic (feat. Pebbles The Invisible Girl)",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/absolutely?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - ABSOLUTELY (feat. Madlib)",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/beef-rap?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Beef Rap",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/kon-queso?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Kon Queso",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/rhymes-like-dimes-feat-dj?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Rhymes Like Dimes (feat. DJ Cucumber Slice)",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/bumpys-message?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - BUMPY'S MESSAGE (feat. Freddie Foxxx)",
            },
            {
              url: "https://soundcloud.com/king_geedorah/anti-matter?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Anti-Matter",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/hey?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Hey!",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/bells-of-doom-1?in=mf-doom-official/sets/the-prof-meets-the-super",
              answer: "MF DOOM - Bells of DOOM",
            },
            {
              url: "https://soundcloud.com/king_geedorah/the-fine-print?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - The Fine Print",
            },
            {
              url: "https://soundcloud.com/danger-doom/vats-of-urine?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Vats of Urine",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/vomitspit?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Vomitspit",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/gumbo?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Gumbo",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/supervillain-intro?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - SUPERVILLAIN (INTRO)",
            },
            {
              url: "https://soundcloud.com/king_geedorah/fastlane?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Fastlane",
            },
            {
              url: "https://soundcloud.com/danger-doom/perfect-hair?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Perfect Hair",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/tick-tick-feat-mf-grimm?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Tick, Tick (feat. MF Grimm)",
            },
            {
              url: "https://soundcloud.com/danger-doom/bada-bing?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Bada Bing",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/batty-boyz?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - BATTY BOYZ",
            },
            {
              url: "https://soundcloud.com/danger-doom/basket-case?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Basket Case",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/lightworks?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - LIGHTWORKS (feat. J Dilla)",
            },
            {
              url: "https://soundcloud.com/mf-doom-official/gas-drawls?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Gas Drawls",
            },
            {
              url: "https://soundcloud.com/danger-doom/old-school-rules-feat-talib?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Old School Rules (feat. Talib Kweli)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/my-favorite-ladies-2?in=mf-doom-official/sets/the-prof-meets-the-super",
              answer: "MF DOOM - My Favorite Ladies",
            },           
            {
              url: "https://soundcloud.com/mf-doom-official/doomsday-feat-pebbles-the?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Doomsday (feat. Pebbles The Invisible Girl)",
            },            
            {
              url: "https://soundcloud.com/king_geedorah/monster-zero?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Monster Zero",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/more-rhymin-feat-kurious?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - MORE RHYMIN",
            },           
             {
              url: "https://soundcloud.com/mf-doom-official/deep-fried-frenz?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Deep Fried Frenz",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/one-beer?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - One Beer",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/yessir-feat-raekwon?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - YESSIR! (feat. Raekwon)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/cellz-pt-1-feat-charles?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - CELLZ, Pt. 1 (feat. Charles Bukowiski)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/cellz-pt-2?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - CELLZ, Pt. 2",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/poo-putt-platter?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Poo-Putt Platter",
            },            
            {
              url: "https://soundcloud.com/danger-doom/crosshairs?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Crosshairs",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/thats-that?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - THAT'S THAT",
            },            
            {
              url: "https://soundcloud.com/danger-doom/the-mask-feat-ghostface?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - The Mask (feat. Ghostface Killah)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/avalanche-1",
              answer: "MF DOOM - Avalanche",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/all-outta-ale-1?in=mf-doom-official/sets/the-prof-meets-the-super",
              answer: "MF DOOM - All Outta Ale",
            },            
            {
              url: "https://soundcloud.com/danger-doom/space-hos?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Space Hos",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/the-finest-feat-tommy-gunn?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - The Finest (feat. Tommy Gunn)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/fig-leaf-bi-carbonate?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Fig Leaf Bi-Carbonate",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/gazzillion-ear?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - GAZZILLION EAR (feat. J Dilla)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/microwave-mayo?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - MICROWAEVE MAYO",
            },            
            {
              url: "https://soundcloud.com/danger-doom/el-chupa-nibre?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - El CHupa Nibre",
            },            
            {
              url: "https://soundcloud.com/king_geedorah/take-me-to-your-leader?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Take Me To Your Leader",
            },           
            {
              url: "https://soundcloud.com/mf-doom-official/go-with-the-flow?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Go with the FLow",
            },            
            {
              url: "https://soundcloud.com/king_geedorah/the-final-hour?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - The Final Hour",
            },            
            {
              url: "https://soundcloud.com/danger-doom/sofa-king?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Sofa King",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/guinnesses-feat-angelika-4ize?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Guinnessess feat. Angelika & 4ize",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/kookies?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Kookies",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/who-you-think-i-am-feat-k-d?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Who You Think I Am? (feat. K.D, King Ghidra, King, Megalon, Ro-Dan & X-Ray)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/hoe-cakes?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Hoe Cakes",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/the-hands-of-doom-skit?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - The Hands of Doom (Skit)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/the-mystery-of-doom-skit?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - The Mystery of Doom (Skit)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/angelz-feat-tony-starks?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - ANGELZ (feat. Ghostface Killah)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/thats-that?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - THAT'S THAT",
            ...
            {
              url: "https://soundcloud.com/danger-doom/benzi-box-feat-cee-lo?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Benzi Box (feat. CeeLo Green)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/back-in-the-days-skit?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Back in the Days (Skit)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/rapp-snitch-knishes-feat-mr?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Rapp Snitch Knishes feat. Mr. Fantastik",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/kon-karne?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Kon Karne",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/ballskin?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - BALLSKIN",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/potholderz-feat-count-bass-d?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Potholderz feat. Count Bass D",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/supervillainz-feat-mobonix?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - SUPERVILLAINZ (feat. Kurious, Mobonix, Posdnous, Prince Paul & Slug)",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/go-with-the-flow?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Go with the Flow",
            ...
            {
              url: "https://soundcloud.com/king_geedorah/i-wonder?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - I Wonder",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/rap-ambush?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - RAP AMBUSH",
            },            
            {
              url: "https://soundcloud.com/danger-doom/mince-meat?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - Mince Meat",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/fillet-o-rapper?in=mf-doom-official/sets/mm-food-1",
              answer: "MF DOOM - Fillet-O-Rapper",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/dead-bent?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Dead Bent",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/still-dope-feat-empress-starhh?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - STILL DOPE (feat. Empress Starhh)",
            },            
            {
              url: "https://soundcloud.com/king_geedorah/next-levels?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Next Levels",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/thank-ya?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - THANK YA",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/doom-are-you-awake-skit?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Doom, Are You Awake? (Skit)",
            },            
            {
              url: "https://soundcloud.com/danger-doom/no-names-black-debbie?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - No Names (feat. Money Mark)",
            },           
            {
              url: "https://soundcloud.com/mf-doom-official/red-and-gold-feat-king-ghidra?in=mf-doom-official/sets/operation-doomsday-original",
              answer: "MF DOOM - Red and Gold (feat. King Ghidra)",
            },            
            {
              url: "https://soundcloud.com/king_geedorah/lockjaw?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Lockjaw",
            },            
            {
              url: "https://soundcloud.com/danger-doom/a-t-h-f-aqua-teen-hunger-force?in=danger-doom/sets/the-mouse-and-the-mask-1",
              answer: "Danger Doom - A.T.H.F (Aqua Teen Hunger Force)",
            },            
            {
              url: "https://soundcloud.com/king_geedorah/fazers?in=king_geedorah/sets/take-me-to-your-leader-3",
              answer: "King Geedorah - Fazers",
            },            
            {
              url: "https://soundcloud.com/mf-doom-official/the-green-whore-net?in=mf-doom-official/sets/born-like-this-2",
              answer: "MF DOOM - THE.GREEN.WHORE.NET",
            }
          ],
          Pn
        ).subscribe,
      ...
      return {
        c() {
          ...
          Q(l.$$.fragment),
            ...
            (C = x()),
            H && H.c(),
            (An.title = "MF DOOM Heardle"),
            M(t, "name", "description"),
            M(
              t,
              "content",
              "Guess the MF DOOM song from the intro in as few tries as possible"
            ),
