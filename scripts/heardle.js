var app = (function() {
        ...
        m.$on("click", e[4]), {
          c() {
            ...
            Q(i.$$.fragment),
              ...
              (l = x()),
              (u = w("h1")),
              (u.textContent = "Kanye West Heardle"),
              (c = x()),
              (d = w("div")),
              Q(h.$$.fragment),
              (f = x()),
    ...
    function Nt(t) {
      ...
      return {
        c() {
          (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> but for Kanye West songs. Each song is randomly chosen from his discography, including features.</p> \n\n<p class="mb-3">Made by <a href="https://twitter.com/eggtartemily">@eggtartemily</a>. All copyright goes to Kanye West, RCA Records, and other relevant parties.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>. See the source code <a href="https://glitch.com/edit/#!/Kanye West-heardle">here</a>.'),
          M(n, "class", "text");
        },
        m(e, t) {
          g(e, n, t);
        ...
        (O = new Rt({})), {
          c() {
            ...
            W.c(),
              ...
              (m = w("div")),
              (k = w("div")),
              (k.textContent = "Next Kanye West song in:"),
              (b = x()),
              Q(S.$$.fragment),
              (D = x()),
              (T = w("div")),
    ...
    function an(e) {
      ...
      return {
        c() {
          (t = _("You got today's Kanye West Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
        },
        m(e, s) {
    ...
    function ln(e) {
      ...
      return {
        c() {
          (t = _("You got today's Kanye West Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
    ...
    function un(t) {
      ...
      return {
        c() {
          n = _("You didn't get today's Kanye West Heardle. Better luck tomorrow!");
        },
        m(e, t) {
          g(e, n, t);
        },
      ...
      return (
        ...
        [
          ...
          () => {
            ...
            let e = "Kanye West Heardle #" + (s.id + 1),
              t = "";
            a
              ?
            ...
            let o =
              ...
              t +
              "\n\n" +
              "https://Kanye West-heardle.glitch.me/";
            if (
              !navigator.share ||
      ...
      On = {
        subscribe: ue(
          [{
            ...
            {
              url: "https://soundcloud.com/kanyewest/heartless",
              answer: "Kanye West - Heartless",
            },
            {
              url: "https://soundcloud.com/kanyewest/bound-2",
              answer: "Kanye West - Bound 2",
            },
            {
              url: "https://soundcloud.com/kanyewest/hurricane",
              answer: "Kanye West - Hurricane",
            },
            {
              url: "https://soundcloud.com/kanyewest/praise-god",
              answer: "Kanye West. - Praise God",
            },
            {
              url: "https://soundcloud.com/kanyewest/off-the-grid",
              answer: "Kanye West - Off The Grid",
            },
            {
              url: "https://soundcloud.com/kanyewest/moon",
              answer: "Kanye West - Moon",
            },
            {
            ...
            {
              url: "https://soundcloud.com/kanyewest/all-of-the-lights",
              answer: "Kanye West - All Of The Lights",
            },
            {
              url: "https://soundcloud.com/kanyewest/nomorepartiesinla",
              answer: "Kanye West - NO MORE PARTIES IN L.A. FEAT. KENDRICK LAMAR",
            },
            {
              url: "https://soundcloud.com/kanyewest/follow-god",
              answer: "Kanye West - Follow God",
            },
            {
              url: "https://soundcloud.com/kanyewest/famous",
              answer: "Kanye West - Famous",
            },
            {
              url: "https://soundcloud.com/kanyewest/pure-souls",
              answer: "Kanye West - Pure Souls",
            },
            {
              url: "https://soundcloud.com/kanyewest/jail",
              answer: "Kanye West - Jail",
            },
            {
              url: "https://soundcloud.com/kanyewest/no-child-left-behind",
              answer: "Kanye West - No Child Left Behind",
            },
            {
              url: "https://soundcloud.com/kanyewest/heaven-and-hell",
              answer: "Kanye West - Heaven and Hell",
            },
            {
              url: "https://soundcloud.com/kanyewest/jonah",
              answer: "Kanye West - Jonah",
            },
            {
              url: "https://soundcloud.com/kanyewest/believe-what-i-say",
              answer: "Kanye West - Believe What I Say",
            },
            {
              url: "https://soundcloud.com/kanyewest/24a1",
              answer: "Kanye West - 24",
            },
            {
              url: "https://soundcloud.com/kanyewest/life-of-the-party-1",
              answer: "Kanye West - Life Of The Party",
            },
            {
              url: "https://soundcloud.com/kanyewest/junya",
              answer: "Kanye West - Junya",
            },
            {
              url: "https://soundcloud.com/kanyewest/ok-ok",
              answer: "Kanye West - Ok Ok",
            },
            {
              url: "https://soundcloud.com/kanyewest/facts-explicit",
              answer: "Kanye West - FACTS (EXPLICIT)",
            },
            {
              url: "https://soundcloud.com/kanyewest/champion",
              answer: "Kanye West - Champion",
            },
            {
              url: "https://soundcloud.com/kanyewest/monster-album-version-explicit",
              answer: "Kanye West - Monster (feat. JAY-Z, Rick Ross, Nicki Minaj & Bon Iver)",
            },
            {
              url: "https://soundcloud.com/kanyewest/lord-i-need-you",
              answer: "Kanye West - Lord I Need You",
            }
          ],
          Pn
        ).subscribe,
      ...
      return {
        c() {
          ...
          Q(l.$$.fragment),
            ...
            (C = x()),
            H && H.c(),
            (An.title = "Kanye West Heardle"),
            M(t, "name", "description"),
            M(
              t,
              "content",
              "Guess the Kanye West song from the intro in as few tries as possible"
            ),
